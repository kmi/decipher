...
public class LispBridge {
	...
	//	 interpreter.eval("(load \"/Decipher/Codes/atms/package.lisp\")");
	//	 interpreter.eval("(load \"/Decipher/Codes/atms/atms-interface.lisp\")");
	//	 interpreter.eval("(load \"/Decipher/Codes/atms/atms-database.lisp\")");
