...
//	public Response doGet(@PathParam("dossierID") String sID, @PathParam("action") String action, @Context UriInfo ui){
	public Response doGet(@PathParam("action") String action, @QueryParam("dossierID") String sID, @Context UriInfo ui){
	...
	/*	if (action.equalsIgnoreCase("clusterEvents")){
		...
		if (action.equalsIgnoreCase("recommendEvents")){
			...
			NarrativeRecommender narrRecommen= new NarrativeRecommender(repQueryURI, dossierID,lispATMS);
...
//	public Response doGet(@PathParam("dossierID") String sID, @PathParam("action") String action, @Context UriInfo ui, String recalulate){
	public Response doGet(@PathParam("action") String action, @QueryParam("dossierID") String sID, @Context UriInfo ui, @PathParam("cache_or_recalculate") String mechanism){ 
        Response resp = null;		 
//		String dossierID = config.getProperty("DOSSIER_NS") + sID;
