...
//			RDF_rep_conn = new RDFRepositoryConnector(config.getProperty("REPOSITORY_URL"), config.getProperty("REPOSITORY_NAME"));
			RDF_rep_conn = new RDFRepositoryConnector("http://localhost:8088/openrdf-sesame/","RecommenderDemo");
//			RDF_rep_conn = new RDFRepositoryConnector("http://PCKM245.open.ac.uk:8080/openrdf-sesame/","Decipher");
