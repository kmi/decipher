...
public class EventRecommenderBK {
	...
	public EventRecommenderBK(String dossID) {
		this.dossier = dossID;
	...
	public EventRecommenderBK(String repQueryURI, String dossID, int clusterNum) {
		this.queryEndPoint =repQueryURI;
		this.dossier = dossID;
		this.eventCluNum =clusterNum;
		this.cacheFileName = File.separator + "Decipher" + File.separator +"tmp" + File.separator + dossier.substring(dossier.lastIndexOf("/")+1) +"_recommendedEvents.xml";
	}
	public EventRecommenderBK(String repQueryURI, String dossID, String plotID, int clusterNum) {
		this.dossier = dossID;
		this.plot = plotID;
		this.eventCluNum =clusterNum;
...
//		String plot = "http://mckm219286.open.ac.uk/decipher/trunk/decipher-3/plot/4413";
		EventRecommenderBK recommend= new EventRecommenderBK(dossier);
