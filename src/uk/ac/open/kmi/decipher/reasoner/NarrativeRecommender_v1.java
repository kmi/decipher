...
import uk.ac.open.kmi.decipher.reasoner.facility.LispBridge_v1;
...
public class NarrativeRecommender_v1 {
...
*/	
   ...
   //     tMap.put("material", "usesMaterial");
	...
	LispBridge_v1 LispATMS;
	
	public NarrativeRecommender_v1(String repQueryURI, String dossier, LispBridge_v1 Lisp_atms) {
		this.queryEndPoint = repQueryURI;
		this.dossierID = dossier;
		this.cacheFileName = TEMP_DIR + File.separator + dossierID.substring(dossierID.lastIndexOf("/")+1) +"_recommendedNarratives.xml";
		LispATMS = Lisp_atms;
	}
...
//		System.out.println("the total of properties are: " + propFileMap.keySet().size());
	...
	public static void main(String[] args) throws Exception{
		LispBridge_v1 lispATMS = LispBridge_v1.getInstance();
...
//		String queryURI = "http://localhost:8088/openrdf-sesame/repositories/RecommenderDemo?query=";
		...
		NarrativeRecommender_v1 nr= new NarrativeRecommender_v1(queryURI,dossID,lispATMS);
//		nr.getCount();
